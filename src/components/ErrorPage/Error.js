  ...
  return (
    <>
      <div className="bg-gray-200 h-screen flex justify-center items-center">
        <div className="shadow-xl p-12 rounded-lg bg-gray-800 w-3/4">
          <div className="flex justify-center items-center fill-gray-300">
            <svg
              className="w-1/6 "
          ...
          <h1 className="text-4xl font-semibold mt-8 text-gray-100 text-center">
            Sorry For Your Trouble,This Page Is Underconstruction
          </h1>
        </div>
      </div>
    </>
